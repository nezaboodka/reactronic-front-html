...
export function RxDiv<O = void>(id: string, deps: any, render: Render<HTMLDivElement, O>, override?: Override<O, HTMLDivElement>): Manifest<HTMLDivElement, O> { return manifest(id, deps, render, override, Html.div) }
export function RxSpan<O = void>(id: string, deps: any, render: Render<HTMLSpanElement, O>, override?: Override<O, HTMLSpanElement>): Manifest<HTMLSpanElement, O> { return manifest(id, deps, render, override, Html.span) }
export function RxSection<O = void>(id: string, deps: any, render: Render<HTMLElement, O>, override?: Override<O, HTMLElement>): Manifest<HTMLElement, O> { return manifest(id, deps, render, override, Html.section) }
export function RxNav<O = void>(id: string, deps: any, render: Render<HTMLElement, O>, override?: Override<O, HTMLElement>): Manifest<HTMLElement, O> { return manifest(id, deps, render, override, Html.nav) }
export function RxLink<O = void>(id: string, deps: any, render: Render<HTMLLinkElement, O>, override?: Override<O, HTMLLinkElement>): Manifest<HTMLLinkElement, O> { return manifest(id, deps, render, override, Html.link) }
export function RxButton<O = void>(id: string, deps: any, render: Render<HTMLButtonElement, O>, override?: Override<O, HTMLButtonElement>): Manifest<HTMLButtonElement, O> { return manifest(id, deps, render, override, Html.button) }
export function RxImage<O = void>(id: string, deps: any, render: Render<HTMLImageElement, O>, override?: Override<O, HTMLImageElement>): Manifest<HTMLImageElement, O> { return manifest(id, deps, render, override, Html.image) }
export function RxInput<O = void>(id: string, deps: any, render: Render<HTMLInputElement, O>, override?: Override<O, HTMLInputElement>): Manifest<HTMLInputElement, O> { return manifest(id, deps, render, override, Html.input) }
export function RxSelect<O = void>(id: string, deps: any, render: Render<HTMLSelectElement, O>, override?: Override<O, HTMLSelectElement>): Manifest<HTMLSelectElement, O> { return manifest(id, deps, render, override, Html.select) }
export function RxOption<O = void>(id: string, deps: any, render: Render<HTMLOptionElement, O>, override?: Override<O, HTMLOptionElement>): Manifest<HTMLOptionElement, O> { return manifest(id, deps, render, override, Html.option) }
export function RxLabel<O = void>(id: string, deps: any, render: Render<HTMLLabelElement, O>, override?: Override<O, HTMLLabelElement>): Manifest<HTMLLabelElement, O> { return manifest(id, deps, render, override, Html.label) }
export function RxHeader<O = void>(id: string, deps: any, render: Render<HTMLElement, O>, override?: Override<O, HTMLElement>): Manifest<HTMLElement, O> { return manifest(id, deps, render, override, Html.header) }
export function RxAudio<O = void>(id: string, deps: any, render: Render<HTMLAudioElement, O>, override?: Override<O, HTMLAudioElement>): Manifest<HTMLAudioElement, O> { return manifest(id, deps, render, override, Html.audio) }
export function RxVideo<O = void>(id: string, deps: any, render: Render<HTMLVideoElement, O>, override?: Override<O, HTMLVideoElement>): Manifest<HTMLVideoElement, O> { return manifest(id, deps, render, override, Html.video) }
export function RxIframe<O = void>(id: string, deps: any, render: Render<HTMLIFrameElement, O>, override?: Override<O, HTMLIFrameElement>): Manifest<HTMLIFrameElement, O> { return manifest(id, deps, render, override, Html.iframe) }
export function RxSource<O = void>(id: string, deps: any, render: Render<HTMLSourceElement, O>, override?: Override<O, HTMLSourceElement>): Manifest<HTMLSourceElement, O> { return manifest(id, deps, render, override, Html.source) }
export function RxI<O = void>(id: string, deps: any, render: Render<HTMLElement, O>, override?: Override<O, HTMLElement>): Manifest<HTMLElement, O> { return manifest(id, deps, render, override, Html.i) }
export function RxB<O = void>(id: string, deps: any, render: Render<HTMLElement, O>, override?: Override<O, HTMLElement>): Manifest<HTMLElement, O> { return manifest(id, deps, render, override, Html.b) }
export function RxU<O = void>(id: string, deps: any, render: Render<HTMLElement, O>, override?: Override<O, HTMLElement>): Manifest<HTMLElement, O> { return manifest(id, deps, render, override, Html.u) }
export function RxOL<O = void>(id: string, deps: any, render: Render<HTMLOListElement, O>, override?: Override<O, HTMLOListElement>): Manifest<HTMLOListElement, O> { return manifest(id, deps, render, override, Html.ol) }
export function RxUL<O = void>(id: string, deps: any, render: Render<HTMLUListElement, O>, override?: Override<O, HTMLUListElement>): Manifest<HTMLUListElement, O> { return manifest(id, deps, render, override, Html.ul) }
export function RxLI<O = void>(id: string, deps: any, render: Render<HTMLLIElement, O>, override?: Override<O, HTMLLIElement>): Manifest<HTMLLIElement, O> { return manifest(id, deps, render, override, Html.li) }
export function RxTR<O = void>(id: string, deps: any, render: Render<HTMLTableRowElement, O>, override?: Override<O, HTMLTableRowElement>): Manifest<HTMLTableRowElement, O> { return manifest(id, deps, render, override, Html.tr) }
export function RxTH<O = void>(id: string, deps: any, render: Render<HTMLTableHeaderCellElement, O>, override?: Override<O, HTMLTableHeaderCellElement>): Manifest<HTMLTableHeaderCellElement, O> { return manifest(id, deps, render, override, Html.th) }
export function RxTD<O = void>(id: string, deps: any, render: Render<HTMLTableDataCellElement, O>, override?: Override<O, HTMLTableDataCellElement>): Manifest<HTMLTableDataCellElement, O> { return manifest(id, deps, render, override, Html.td) }
export function RxCaption<O = void>(id: string, deps: any, render: Render<HTMLTableCaptionElement, O>, override?: Override<O, HTMLTableCaptionElement>): Manifest<HTMLTableCaptionElement, O> { return manifest(id, deps, render, override, Html.caption) }
...
export function RxSvg<O = void>(id: string, deps: any, render: Render<SVGSVGElement, O>, override?: Override<O, SVGSVGElement>): Manifest<SVGSVGElement, O> { return manifest(id, deps, render, override, Svg.svg) }
export function RxSvgLink<O = void>(id: string, deps: any, render: Render<SVGAElement, O>, override?: Override<O, SVGAElement>): Manifest<SVGAElement, O> { return manifest(id, deps, render, override, Svg.link) }
export function RxAnimate<O = void>(id: string, deps: any, render: Render<SVGAnimateElement, O>, override?: Override<O, SVGAnimateElement>): Manifest<SVGAnimateElement, O> { return manifest(id, deps, render, override, Svg.animate) }
export function RxAnimateMotion<O = void>(id: string, deps: any, render: Render<SVGAnimateMotionElement, O>, override?: Override<O, SVGAnimateMotionElement>): Manifest<SVGAnimateMotionElement, O> { return manifest(id, deps, render, override, Svg.animateMotion) }
export function RxAnimateTransform<O = void>(id: string, deps: any, render: Render<SVGAnimateTransformElement, O>, override?: Override<O, SVGAnimateTransformElement>): Manifest<SVGAnimateTransformElement, O> { return manifest(id, deps, render, override, Svg.animateTransform) }
export function RxCircle<O = void>(id: string, deps: any, render: Render<SVGCircleElement, O>, override?: Override<O, SVGCircleElement>): Manifest<SVGCircleElement, O> { return manifest(id, deps, render, override, Svg.circle) }
export function RxClipPath<O = void>(id: string, deps: any, render: Render<SVGClipPathElement, O>, override?: Override<O, SVGClipPathElement>): Manifest<SVGClipPathElement, O> { return manifest(id, deps, render, override, Svg.clipPath) }
export function RxDefs<O = void>(id: string, deps: any, render: Render<SVGDefsElement, O>, override?: Override<O, SVGDefsElement>): Manifest<SVGDefsElement, O> { return manifest(id, deps, render, override, Svg.defs) }
export function RxDesc<O = void>(id: string, deps: any, render: Render<SVGDescElement, O>, override?: Override<O, SVGDescElement>): Manifest<SVGDescElement, O> { return manifest(id, deps, render, override, Svg.desc) }
export function RxEllipse<O = void>(id: string, deps: any, render: Render<SVGEllipseElement, O>, override?: Override<O, SVGEllipseElement>): Manifest<SVGEllipseElement, O> { return manifest(id, deps, render, override, Svg.ellipse) }
export function RxForeignObject<O = void>(id: string, deps: any, render: Render<SVGForeignObjectElement, O>, override?: Override<O, SVGForeignObjectElement>): Manifest<SVGForeignObjectElement, O> { return manifest(id, deps, render, override, Svg.foreignObject) }
export function RxG<O = void>(id: string, deps: any, render: Render<SVGGElement, O>, override?: Override<O, SVGGElement>): Manifest<SVGGElement, O> { return manifest(id, deps, render, override, Svg.g) }
export function RxSvgImage<O = void>(id: string, deps: any, render: Render<SVGImageElement, O>, override?: Override<O, SVGImageElement>): Manifest<SVGImageElement, O> { return manifest(id, deps, render, override, Svg.image) }
export function RxLine<O = void>(id: string, deps: any, render: Render<SVGLineElement, O>, override?: Override<O, SVGLineElement>): Manifest<SVGLineElement, O> { return manifest(id, deps, render, override, Svg.line) }
export function RxLinearGradient<O = void>(id: string, deps: any, render: Render<SVGLinearGradientElement, O>, override?: Override<O, SVGLinearGradientElement>): Manifest<SVGLinearGradientElement, O> { return manifest(id, deps, render, override, Svg.linearGradient) }
export function RxMarker<O = void>(id: string, deps: any, render: Render<SVGMarkerElement, O>, override?: Override<O, SVGMarkerElement>): Manifest<SVGMarkerElement, O> { return manifest(id, deps, render, override, Svg.marker) }
export function RxMask<O = void>(id: string, deps: any, render: Render<SVGMaskElement, O>, override?: Override<O, SVGMaskElement>): Manifest<SVGMaskElement, O> { return manifest(id, deps, render, override, Svg.mask) }
export function RxPath<O = void>(id: string, deps: any, render: Render<SVGPathElement, O>, override?: Override<O, SVGPathElement>): Manifest<SVGPathElement, O> { return manifest(id, deps, render, override, Svg.path) }
export function RxPattern<O = void>(id: string, deps: any, render: Render<SVGPatternElement, O>, override?: Override<O, SVGPatternElement>): Manifest<SVGPatternElement, O> { return manifest(id, deps, render, override, Svg.pattern) }
export function RxPolygon<O = void>(id: string, deps: any, render: Render<SVGPolygonElement, O>, override?: Override<O, SVGPolygonElement>): Manifest<SVGPolygonElement, O> { return manifest(id, deps, render, override, Svg.polygon) }
export function RxPolyline<O = void>(id: string, deps: any, render: Render<SVGPolylineElement, O>, override?: Override<O, SVGPolylineElement>): Manifest<SVGPolylineElement, O> { return manifest(id, deps, render, override, Svg.polyline) }
export function RxRadialGradient<O = void>(id: string, deps: any, render: Render<SVGRadialGradientElement, O>, override?: Override<O, SVGRadialGradientElement>): Manifest<SVGRadialGradientElement, O> { return manifest(id, deps, render, override, Svg.radialGradient) }
export function RxRect<O = void>(id: string, deps: any, render: Render<SVGRectElement, O>, override?: Override<O, SVGRectElement>): Manifest<SVGRectElement, O> { return manifest(id, deps, render, override, Svg.rect) }
export function RxText<O = void>(id: string, deps: any, render: Render<SVGTextElement, O>, override?: Override<O, SVGTextElement>): Manifest<SVGTextElement, O> { return manifest(id, deps, render, override, Svg.text) }
export function RxTextPath<O = void>(id: string, deps: any, render: Render<SVGTextPathElement, O>, override?: Override<O, SVGTextPathElement>): Manifest<SVGTextPathElement, O> { return manifest(id, deps, render, override, Svg.textPath) }
export function RxUse<O = void>(id: string, deps: any, render: Render<SVGUseElement, O>, override?: Override<O, SVGUseElement>): Manifest<SVGUseElement, O> { return manifest(id, deps, render, override, Svg.use) }
export function RxView<O = void>(id: string, deps: any, render: Render<SVGViewElement, O>, override?: Override<O, SVGViewElement>): Manifest<SVGViewElement, O> { return manifest(id, deps, render, override, Svg.view) }
